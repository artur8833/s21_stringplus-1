...
START_TEST(memcmpTest1) {   
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest1, secondValueTest1, n), memcmp(firstValueTest1, secondValueTest1, n));
}
END_TEST
...
START_TEST(memcmpTest2) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest2, secondValueTest2, n), memcmp(firstValueTest2, secondValueTest2, n));
}
...
START_TEST(memcmpTest3) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest3, secondValueTest3, n), memcmp(firstValueTest3, secondValueTest3, n));
}
...
START_TEST(memcmpTest4) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest4, secondValueTest4, n), memcmp(firstValueTest4, secondValueTest4, n));
}
...
START_TEST(memcmpTest5) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest5, secondValueTest5, n), memcmp(firstValueTest5, secondValueTest5, n));
}
...
START_TEST(memcmpTest6) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest6, secondValueTest6, n), memcmp(firstValueTest6, secondValueTest6, n));
}
...
START_TEST(memcmpTest7) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest7, secondValueTest7, n), memcmp(firstValueTest7, secondValueTest7, n));
}
...
START_TEST(memcmpTest8) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest8, secondValueTest8, n), memcmp(firstValueTest8, secondValueTest8, n));
}
...
START_TEST(memcmpTest9) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest9, secondValueTest9, n), memcmp(firstValueTest9, secondValueTest9, n));
}
...
START_TEST(memcmpTest10) { 
  ...
  ck_assert_int_eq(s21_memcmp(firstValueTest10, secondValueTest10, n), memcmp(firstValueTest10, secondValueTest10, n));
}
