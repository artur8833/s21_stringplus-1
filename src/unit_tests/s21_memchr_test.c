...
START_TEST(memchrTest2) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, 'd', countValue), memchr(strValue, 'd', countValue));
}
...
START_TEST(memchrTest3) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, 101, countValue), memchr(strValue, 101, countValue));
}
...
START_TEST(memchrTest6) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, 'n', countValue), memchr(strValue, 'n', countValue));
}
...
START_TEST(memchrTest9) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, 'k', countValue), memchr(strValue, 'k', countValue));
}
...
START_TEST(memchrTest10) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, ' ', countValue), memchr(strValue, ' ', countValue));
}
...
START_TEST(memchrTest13) { 
  ...
  ck_assert_ptr_eq(s21_memchr(strValue, 'y', countValue), memchr(strValue, 'y', countValue));
}
