...
START_TEST(strncatTest1) {
  ...
  ck_assert_char_eq(s21_strncat(testStrValue1, testIntValue1, testCountValue1), strncat(testStrValue1, testIntValue1, testCountValue1));
  ck_assert_char_eq(s21_strncat(testStrValue1, testIntValue1, testCountValue1), strncat(testStrValue1, testIntValue1, testCountValue1));
  ck_assert_char_eq(s21_strncat(testStrValue1, testIntValue1, testCountValue1), strncat(testStrValue1, testIntValue1, testCountValue1));
}
END_TEST;
...
Suite *strncatTest(void) {
  ...
  tcase_add_test(tc, strncatTest2);
